////////////////////////////////////////////////////////////////////////////////
// Altered example from spirograph code by R. Luke DuBois                     //
// See: https://p5js.org/examples/simulate-spirograph.html                    //
////////////////////////////////////////////////////////////////////////////////

var NUMSINES; // how many? [based on hour (1-12)]
...
function setup() {
  ...
  // Add mapping for time in hour and minutes
  NUMSINES = (hour() == 0 ? 12 : hour()%12);
  sines = new Array(NUMSINES);
  ratio = map(minute(), 0, 59, 0.25, 8);
